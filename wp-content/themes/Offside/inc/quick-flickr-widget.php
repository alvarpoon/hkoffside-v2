...
class Quick_Flickr_Widget extends WP_Widget {
  ...
  public function widget( $args, $instance ) {
    ...
    if ( is_wp_error( $photos ) ) {
      ...
      foreach ( $photos as $photo ) {
        ...
        $item = sprintf( '<a href="%s"><img width="150" height="150" src="%s" alt="%s" /></a>', $link, $source, $title );
  ...
  public function form( $instance ) {
    ...
    <p>
      <label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php _e( 'Username or RSS:', 'margot' ); ?></label> 
      <input class="widefat" id="<?php echo $this->get_field_id( 'username' ); ?>" name="<?php echo $this->get_field_name( 'username' ); ?>" type="text" value="<?php echo esc_attr( $username ); ?>" />
    </p>
    <p>
      <label for="<?php echo $this->get_field_id( 'tags' ); ?>"><?php _e( 'Tags:', 'margot' ); ?></label> 
    ...
    <p>
      <label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e( 'Count:', 'margot' ); ?></label><br />
